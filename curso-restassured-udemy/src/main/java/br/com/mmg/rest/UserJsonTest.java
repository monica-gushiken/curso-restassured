...
public class UserJsonTest {
	...
	public void devoFazerVerificacoesAvancadas() {
		...
		.then()
			.statusCode(200)
			.body("$", hasSize(3))
			.body("age.findAll{it <= 25}.size()", is(2)) //quantos usuários tem idade até 25 anos
			.body("age.findAll{it <= 25 && it > 20}.size()", is(1)) //quantos usuários tem idade entre 20 e 25 anos
			...
			.body("salary.findAll{it != null}sum()",is(closeTo(3734.5678f,0.001))) //closeTo dá uma margem de erro
